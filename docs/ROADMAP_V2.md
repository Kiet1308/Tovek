...
- [ ] Mở rộng vùng constructor qua khai báo selected local hoặc statement xen kẽ khi có dependency/alias proof. Quét lại corpus có 23 SETLIST fallback ở 22 file, đều giữ nguyên so với baseline đã nghiệm thu; cơ chế diamond giới hạn chưa giải quyết các vùng này. [Phân loại từng site](roadmap_v2_acceptance/branch_ui_fallbacks.json).
