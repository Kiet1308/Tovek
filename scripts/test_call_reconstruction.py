...
def fixture():
    ...
    trace = dict(functions=[dict(prototype=3)], final_bindings=[dict(binding_id='b1'), dict(binding_id='b2')],
        call_reconstruction=dict(schema_version=1, model=MODEL, event_limit=4096, occurrence_limit=100000,
            callees_limit=50000, omitted_events=0, omitted_occurrences=0, omitted_callee_registrations=0,
            events=[dict(event_id=1, producer='statement_deinline', callee_binding_at_creation='b9', callee_prototype=3)],
